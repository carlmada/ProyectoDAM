...
/**
 *
 * Ventana para realizar la gestión de los alquileres de las peliculas desde la
...
public class VentanaGestionAlquilerPeliculas extends javax.swing.JFrame {
    ...
    JSONArray jsonArrayPeliculas, jsonArrayUsuarios;
    int posicionPelicula, posicionUsuario;
    UUID idPelicula , idUsuario ;

    /**
     * Constructor de un nuevo formulario Ventana de gestion de alquileres de
     * peliculas.
     */
    ...
    /**
     *
     * Método para crear las tablas que muestren
     * las peliculas y los usuarios para poder 
     * seleccionarlos.
     *
     */
    ...
    /**
     * 
     * Metodo para asignar un alquiler de pelicula 
     * a un usuario.
     *  
     */
    private void alquilarPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alquilarPeliculaActionPerformed
        ...
        if (  (posicionPelicula == -1) || (posicionUsuario == -1)) {
            ...
            if (opcion == JOptionPane.YES_OPTION) {
                ...
                // Enviamos nuestro peticion POST a la API
